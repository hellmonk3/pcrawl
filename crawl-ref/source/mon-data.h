...
/* ******************************************************************
 ...
 - Some further explanations:
   ...
   gmon_use explanation:
    ...
    From MONUSE_OPEN_DOORS on, monsters are capable of handling
    items. Contrary to what one might expect, MONUSE_OPEN_DOORS
    also means a monster is capable of using wands and will also pick
    them up, something that those with MONUSE_OPEN_DOORS won't
    do.
...

{
    ...
    9, 1200,
    0, 10, MST_IRONBOUND_PRESERVER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    M_WARM_BLOOD | M_BATTY | M_NO_POLY_TO | M_FLIES,
    MR_NO_FLAGS,
    8, MONS_BAT, MONS_VAMPIRE_BAT, MH_UNDEAD, 10,
    { {AT_BITE, AF_VAMPIRIC, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 100,
    1, 70, MST_NO_SPELLS, false, S_SILENT,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_BAT,
...

{
    ...
    MR_NO_FLAGS,
    8, MONS_BAT, MONS_FIRE_BAT, MH_NATURAL, 10,
    { {AT_BITE, AF_HELL_HUNT, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 280,
    6, 70, MST_NO_SPELLS, false, S_SILENT,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_BAT,
...

{
    ...
    { {AT_CLAW, AF_CORRODE, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 480,
    8, 40, MST_NO_SPELLS, true, S_SCREECH,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
...
// centaurs ('c')
{
    ...
    { {AT_HIT, AF_PLAIN, 3}, {AT_KICK, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK },
    2, 160,
    3, 0, MST_ARCHER, true, S_SHOUT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 7}, {AT_KICK, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK },
    6, 400,
    4, 0, MST_ARCHER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_CENTAUR,
...

{
    ...
    3, 360,
    2, 30, MST_DEEP_ELF_AIR_MAGE, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 360,
    2, 30, MST_DEEP_ELF_FIRE_MAGE, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 490,
    3, 20, MST_DEEP_ELF_HIGH_PRIEST, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 460,
    0, 30, MST_ANNIHILATOR, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 500,
    0, 30, MST_DEEP_ELF_DEATH_MAGE, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    6, 530,
    0, 30, MST_DEEP_ELF_ELEMENTALIST, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// Mobile plants and fungi ('f')
{
    ...
    { {AT_SPORE, AF_SLEEP, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 90,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 910,
    13, 0, MST_SHAMBLING_MANGROVE, false, S_SILENT,
    I_HUMAN, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
...
// goblins and other small humanoids ('g')
{
    ...
    1, 40,
    2, 0, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
{
    MONS_GNOLL_ELECTRICIAN, 'g', LIGHTBLUE, "gnoll electrician",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_GNOLL, MONS_GNOLL, MH_NATURAL, 10,
    { {AT_HIT, AF_ELEC, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 120,
    2, 0, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
{
    MONS_GNOLL_HALBERDIER, 'g', LIGHTGREEN, "gnoll halberdier",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_GNOLL, MONS_GNOLL, MH_NATURAL, 10,
    { {AT_HIT, AF_REACH, 11}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 120,
    2, 0, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 200,
    0, 40, MST_BOGGART, false, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...
// carnivorous quadrupeds ('h')
{
    ...
    1, 50,
    1, 10, MST_NO_SPELLS, true, S_BARK,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
...

{
    ...
    4, 200,
    4, 20, MST_NO_SPELLS, true, S_HOWL,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 200,
    4, 10, MST_HELL_HOUND, true, S_BARK,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_QUADRUPED,
...
// spriggans ('i')
{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 200,
    2, 50, MST_NO_SPELLS, true, S_SHOUT,
...
{   // both the guy and his ride as one monster
    ...
    { {AT_HIT, AF_REACH, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 400,
    2, 30, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_SMALL, MON_SHAPE_HUMANOID, // ??
...

{
    ...
    5, 440,
    2, 40, MST_SPRIGGAN_BERSERKER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(5),
    MONUSE_OPEN_DOORS, SIZE_LITTLE, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 410,
    1, 40, MST_SPRIGGAN_AIR_MAGE, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(5),
    MONUSE_OPEN_DOORS, SIZE_LITTLE, MON_SHAPE_HUMANOID,
...

{
    ...
    MR_NO_FLAGS,
    10, MONS_SPRIGGAN, MONS_SPRIGGAN, MH_NATURAL, 140,
    { {AT_HIT, AF_WEAKNESS, 19}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 500,
    3, 60, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LITTLE, MON_SHAPE_HUMANOID,
...

{
    ...
    5, 440,
    2, 40, MST_ASSASSIN, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(5),
    MONUSE_OPEN_DOORS, SIZE_LITTLE, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 300,
    3, 20, MST_WIND_DRAKE, true, S_HISS,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED_WINGED,
...
// A skyshark goes into a battle frenzy when it tastes blood.
{
    ...
    { {AT_BITE, AF_BLOODZERK, 10},
      {AT_TAIL_SLAP, AF_PLAIN, 5},
      {AT_TAIL_SLAP, AF_PLAIN, 5}, AT_NO_ATK  },
    5, 350,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 630,
    0, 20, MST_MERFOLK_AQUAMANCER, true, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, SWIM_ENERGY(5),
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_TOUCH, AF_DROWN, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 300,
    4, 20, MST_WATER_NYMPH, true, S_SHOUT,
    I_HUMAN, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// undead corpses ('n')
{
    ...
    { {AT_TOUCH, AF_COLD, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 190,
    1, 10, MST_BOG_BODY, true, S_SILENT,
    I_HUMAN, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_DRAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 190,
...

{
    ...
    I_HUMAN, HT_AMPHIBIOUS, 20, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 90,
    1, 10, MST_ORC_WIZARD, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
{
    MONS_ORC_LANCER, 'o', LIGHTRED, "orc lancer",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    16, MONS_ORC, MONS_ORC, MH_NATURAL, 20,
    { {AT_HIT, AF_REACH, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 180,
    3, 10, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 270,
    5, 10, MST_ORC_KNIGHT, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ORC_SNIPER}, TILE_ERROR
},

{
    ...
    { {AT_HIT, AF_PLAIN, 25}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 560,
    7, 10, MST_BATTLECRY, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 180,
    3, 0, MST_ORC_SORCERER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 180,
    1, 10, MST_ORC_HIGH_PRIEST, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 120,
    0, 20, MST_BURIAL_ACOLYTE, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 200,
    3, 10, MST_DEATH_KNIGHT, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    2, 260,
    4, 10, MST_VAULT_SENTINEL, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 500,
    4, 10, MST_IRONBOUND_CONVOKER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    MR_RES_COLD,
    12, MONS_HUMAN, MONS_HUMAN, MH_NATURAL, 40,
    { {AT_TOUCH, AF_COLD, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 400,
    5, 10, MST_IRONBOUND_FROSTHEART, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 11}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 700,
    4, 0, MST_RAGGED_HIEROPHANT, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// rodents ('r')
{
    ...
    { {AT_BITE, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 20,
    1, 20, MST_NO_SPELLS, true, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_QUADRUPED,
...

{
    ...
    { {AT_TOUCH, AF_CONFUSE, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 280,
    3, 30, MST_NO_SPELLS, true, S_FAINT_SKITTER,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_ARACHNID,
...
// alligators, testudines, and crabs ('t')
{
    ...
    { {AT_BITE, AF_DRAG, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 240,
...

{
    ...
    { {AT_BITE, AF_DRAG, 23}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 450,
    4, 0, MST_NO_SPELLS, true, S_SILENT,
    I_ANIMAL, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED,
...

{
    ...
    4, 520,
    9, 0, MST_FIRE_CRAB, true, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_QUADRUPED, // ??
...

{
    ...
    { {AT_BITE, AF_DRAIN, 15}, {AT_CLAW, AF_DRAIN, 15}, AT_NO_ATK, AT_NO_ATK },
    4, 580,
    9, 0, MST_GHOST_CRAB, true, S_SILENT,
    I_ANIMAL, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_QUADRUPED,
...
// worms and slugs ('w')
{
    MONS_WORM, 'w', LIGHTRED, "glow worm",
...
{
    MONS_RIBBON_WORM, 'w', MAGENTA, "ribbon worm",
    M_NO_SKELETON | M_FAST_REGEN,
    MR_NO_FLAGS,
    3, MONS_WORM, MONS_WORM, MH_NATURAL, 10,
    { {AT_BITE, AF_PLAIN, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 180,
    0, 0, MST_RIBBON_WORM, true, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_SNAKE,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 200,
    1, 0, MST_BRAIN_WORM, true, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_SNAKE,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 350,
    3, 10, MST_SWAMP_WORM, true, S_SILENT,
    I_ANIMAL, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 90,
    1, 0, MST_DART_SLUG, true, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 600,
    6, 0, MST_NO_SPELLS, true, S_SILENT,
    I_ANIMAL, HT_AMPHIBIOUS, 5, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_BARBS, 13}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 490,
    11, 10, MST_NO_SPELLS, true, S_SILENT,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_SNAKE,
...

{
    ...
    { {AT_BITE, AF_VAMPIRIC, 11}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 150,
    2, 50, MST_NO_SPELLS, true, S_BUZZ,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_INSECT_WINGED,
...

{
    ...
    { {AT_STING, AF_POISON_PARALYSE, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 330,
    0, 30, MST_NO_SPELLS, true, S_BUZZ,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_INSECT_WINGED,
...

{
    ...
    { {AT_STING, AF_ELEC, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 360,
    9, 20, MST_SPARK_WASP, true, S_BUZZ,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_TINY, MON_SHAPE_INSECT_WINGED,
...
// angelic beings ('A')
{
    MONS_ANGEL, 'A', WHITE, "clockwork angel",
    M_SPEAKS | M_FLIES,
    MR_NO_FLAGS,
    10, MONS_ANGEL, MONS_ANGEL, MH_NONLIVING, 120,
    { {AT_HIT, AF_PLAIN, 15}, {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK,
       AT_NO_ATK },
    9, 770,
    7, 40, MST_ANGEL, false, S_SHOUT,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM,
...

{
    ...
    1, 50,
    5, 20, MST_NO_SPELLS, true, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 14}, {AT_CLAW, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK },
    3, 500,
    23, 0, MST_RADROACH, true, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_INSECT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 6}, {AT_HIT, AF_PLAIN, 6}, {AT_HIT, AF_PLAIN, 6}, {AT_HIT, AF_PLAIN, 6} },
    6, 380,
    4, 0, MST_ENTROPY_WEAVER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 21}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 760,
    20, 0, MST_BOULDER_BEETLE, true, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_BITE, AF_SCARAB, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 320,
    7, 40, MST_NO_SPELLS, true, S_FAINT_SKITTER,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LITTLE, MON_SHAPE_INSECT,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 390,
    5, 0, MST_BOULDER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 5, DEFAULT_ENERGY,
...

{
    ...
    7, 660,
    7, 0, MST_FIRE_GIANT, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_COLD, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 660,
    7, 0, MST_FROST_GIANT, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_CLEAVE, 35}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 700,
    10, 10, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 20, ATTACK_ENERGY(20),
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    10, 790,
    18, 0, MST_IRON_GIANT, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    3, 600, // hp will be adjusted later
...

{
    ...
    10, 900,
    10, 20, MST_FIRE_DRAGON_BREATH, true, S_LOUD_ROAR,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 500,
    0, 0, MST_NO_SPELLS, true, S_ROAR,
    I_ANIMAL, HT_AMPHIBIOUS, 10, SWIM_ENERGY(5),
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 500,
    14, 0, MST_NO_SPELLS, false, S_SILENT,
...

{
    ...
    { {AT_HIT, AF_ANTIMAGIC, 17}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 450,
    1, 30, MST_QUICKSILVER_DRAGON, false, S_SILENT,
...

{
    ...
    { {AT_HIT, AF_BIG_FIRE, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 330,
    4, 20, MST_NO_SPELLS, false, S_SILENT,
    I_BRAINLESS, HT_AMPHIBIOUS_LAVA, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_MISC,
...

{
    ...
    { {AT_HIT, AF_ENGULF, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 420,
    4, 20, MST_NO_SPELLS, false, S_SILENT,
    I_BRAINLESS, HT_AMPHIBIOUS, 10, SWIM_ENERGY(5),
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_MISC,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 240,
    0, 80, MST_AIR_ELEMENTAL, false, S_SILENT,
    I_BRAINLESS, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_MISC,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 610,
    8, 10, MST_ELEMENTAL_WELLSPRING, false, S_SILENT,
...

{
    ...
    3, 170,
    0, 40, MST_BLINKER, true, S_CROAK,
    I_ANIMAL, HT_AMPHIBIOUS, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_QUADRUPED_TAILLESS,
...

{
    ...
    M_WARM_BLOOD | M_FLIES | M_NO_SKELETON,
    MR_NO_FLAGS,
    13, MONS_GLOWING_ORANGE_BRAIN, MONS_GLOWING_ORANGE_BRAIN, MH_NATURAL, 100,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 550,
    2, 0, MST_GLOWING_ORANGE_BRAIN, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 660,
    7, 0, MST_GREAT_ORB_OF_EYES, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 50,
    3, 0, MST_SHINING_EYE, false, S_SILENT,
...

{
    ...
    M_BATTY | M_FLIES | M_NO_SKELETON,
    MR_NO_FLAGS,
    17, MONS_FLOATING_EYE, MONS_GOLDEN_EYE, MH_NATURAL, 60,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 120,
    0, 50, MST_GOLDEN_EYE, false, S_SILENT,
    I_BRAINLESS, HT_LAND, 20, DEFAULT_ENERGY,
...
// hybrids ('H')
{
    ...
    { {AT_BITE, AF_PLAIN, 13}, {AT_CLAW, AF_PLAIN, 7}, {AT_CLAW, AF_PLAIN, 7},
       AT_NO_ATK },
    6, 490,
    5, 0, MST_MANTICORE, true, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED,
...

{
    ...
    { { AT_HIT, AF_PLAIN, 15 }, { AT_KICK, AF_PLAIN, 15 }, AT_NO_ATK, AT_NO_ATK },
    6, 666,
    0, 20, MST_FENSTRIDER_WITCH, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 15}, {AT_HIT, AF_PLAIN, 12}, {AT_HIT, AF_PLAIN, 12},
       AT_NO_ATK },
    9, 880,
    5, 20, MST_SPHINX, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_CLAW, AF_SWOOP, 6}, {AT_CLAW, AF_PLAIN, 6}, AT_NO_ATK,
       AT_NO_ATK },
    7, 160,
    2, 60, MST_NO_SPELLS, true, S_SCREECH,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
...

{
    ...
    M_SPEAKS | M_WEB_IMMUNE,
    MR_NO_FLAGS,
    10, MONS_JOROGUMO, MONS_JOROGUMO, MH_NATURAL, 60,
    { {AT_HIT, AF_POISON_PARALYSE, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 550,
    4, 30, MST_JOROGUMO, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_WEAKNESS, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    5, 0, MST_NO_SPELLS, false, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
},
{
    ...
    { {AT_HIT, AF_COLD, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    5, 10, MST_NO_SPELLS, false, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
},
{
    ...
    { {AT_HIT, AF_ANTIMAGIC, 27}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 1,
    5, 30, MST_NO_SPELLS, false, S_SHOUT,
...
// jellies ('J')
{
    ...
    M_UNBLINDABLE | M_NO_SKELETON,
    MR_NO_FLAGS,
    10, MONS_JELLY, MONS_ENDOPLASM, MH_NATURAL, 0,
    { {AT_HIT, AF_PLAIN, 1}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 60,
    0, 0, MST_ENDOPLASM, false, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    M_UNBLINDABLE | M_EAT_DOORS | M_WEB_IMMUNE | M_NO_SKELETON,
    MR_NO_FLAGS,
    15, MONS_JELLY, MONS_JELLY, MH_NATURAL, 10,
    { {AT_HIT, AF_CORRODE, 2}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 100,
    0, 0, MST_NO_SPELLS, false, S_SILENT,
    I_BRAINLESS, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_STING, AF_MINIPARA, 8}, {AT_CONSTRICT, AF_CRUSH, 5},
        AT_NO_ATK, AT_NO_ATK },
    1, 260,
    0, 0, MST_BLINK_CLOSE, false, S_SILENT,
    I_BRAINLESS, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_COLD, 12}, {AT_HIT, AF_COLD, 12}, AT_NO_ATK, AT_NO_ATK },
    5, 620,
    0, 0, MST_NO_SPELLS, false, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_BLOB,
...

{
    ...
    { {AT_HIT, AF_CORRODE, 22}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 990,
    0, 0, MST_ACID_SPIT, false, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_BLOB,
...
// kobolds ('K')
{
    ...
    1, 40,
    2, 20, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_SMALL, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 170,
    3, 20, MST_ASSASSIN, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    4, 190,
    2, 20, MST_KOBOLD_DEMONOLOGIST, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_SMALL, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, {AT_CONSTRICT, AF_CRUSH, 5}, AT_NO_ATK, AT_NO_ATK },
    9, 720,
    8, 10, MST_NAGA_SHARPSHOOTER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, MOVE_ENERGY(20),
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_NAGA,
...
// ogres ('O')
{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 200,
    1, 0, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, ATTACK_ENERGY(20),
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
...
// that they wield two weapons... I'm raising their xp modifier. - bwr
{
    ...
    4, 200,
    1, 0, MST_NO_SPELLS, true, S_SHOUT2,
    I_HUMAN, HT_LAND, 10, ATTACK_ENERGY(20),
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    10, 300,
    1, 0, MST_OGRE_MAGE, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, ATTACK_ENERGY(20),
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    8, 600,
    6, 0, MST_IRONBOUND_THUNDERHULK, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, ATTACK_ENERGY(20),
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 6}, {AT_PECK, AF_PLAIN, 3}, {AT_CLAW, AF_PLAIN, 3},
       AT_NO_ATK },
    4, 310,
    0, 30, MST_TENGU_CONJURER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_FLANK, 10}, {AT_PECK, AF_PLAIN, 5}, {AT_CLAW, AF_PLAIN, 5},
       AT_NO_ATK },
    4, 380,
    2, 30, MST_NO_SPELLS, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 17}, {AT_PECK, AF_PLAIN, 6}, {AT_CLAW, AF_PLAIN, 6},
       AT_NO_ATK },
    9, 550,
    2, 30, MST_TENGU_REAVER, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 560,
    6, 20, MST_RAKSHASA, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 3}, {AT_CONSTRICT, AF_CRUSH, 1},
       AT_NO_ATK, AT_NO_ATK },
    1, 30,
    0, 10, MST_NO_SPELLS, true, S_HISS,
    I_ANIMAL, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_SNAKE,
...

{
    ...
    { {AT_CONSTRICT, AF_CRUSH, 4}, {AT_BITE, AF_PLAIN, 10},
       AT_NO_ATK, AT_NO_ATK },
    3, 300,
    4, 20, MST_NO_SPELLS, true, S_HISS,
    I_ANIMAL, HT_AMPHIBIOUS, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_SNAKE,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    5, 440,
    6, 20, MST_GUARDIAN_SERPENT, true, S_SHOUT,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_SNAKE,
...

{
    ...
    { {AT_BITE, AF_ANTIMAGIC, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 240,
    2, 30, MST_NO_SPELLS, false, S_HISS,
    I_ANIMAL, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_SNAKE,
...
{
    MONS_DEEP_TROLL_SHAMAN, 'T', WHITE, "troll shaman",
    M_WARM_BLOOD | M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_TROLL, MONS_DEEP_TROLL, MH_NATURAL, 40,
    { {AT_BITE, AF_PLAIN, 5}, {AT_CLAW, AF_PLAIN, 5},
      {AT_CLAW, AF_PLAIN, 5}, AT_NO_ATK },
    3, 190,
    5, 0, MST_DEEP_TROLL_SHAMAN, true, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
...
// vampires ('V')
{
    ...
    { {AT_HIT, AF_PLAIN, 8}, {AT_BITE, AF_VAMPIRIC, 8}, AT_NO_ATK,
       AT_NO_ATK },
    4, 330,
    5, 10, MST_VAMPIRE, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 23}, {AT_BITE, AF_VAMPIRIC, 8}, AT_NO_ATK,
       AT_NO_ATK },
    10, 700,
...

{
    ...
    M_SPEAKS | M_WARM_BLOOD | M_FLIES,
    MR_RES_COLD,
    15, MONS_VAMPIRE, MONS_VAMPIRE, MH_UNDEAD, 80,
    { {AT_HIT, AF_PLAIN, 4}, {AT_BITE, AF_VAMPIRIC, 4}, AT_NO_ATK,
       AT_NO_ATK },
    5, 280,
    5, 10, MST_VAMPIRE_MAGE, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_BLINK_WITH, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 160,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 400,
    0, 30, MST_FLAYED_GHOST, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    M_SEE_INVIS | M_INSUBSTANTIAL | M_SHADOWY | M_FLIES,
    MR_NO_FLAGS,
    18, MONS_WRAITH, MONS_SHADOW, MH_UNDEAD, 40,
    { {AT_HIT, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 90,
    3, 30, MST_SHADOW, false, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_SMALL, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 10}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 240,
    3, 20, MST_NO_SPELLS, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_DRAIN_SPEED, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 330,
    0, 0, MST_NO_SPELLS, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    M_SEE_INVIS | M_INSUBSTANTIAL | M_FLIES | M_SHADOWY,
    MR_VUL_FIRE | mrd(MR_RES_COLD, 3),
    10, MONS_WRAITH, MONS_FREEZING_WRAITH, MH_UNDEAD, 40,
    { {AT_HIT, AF_COLD, 9}, {AT_HIT, AF_DRAIN_SPEED, 9}, AT_NO_ATK, AT_NO_ATK },
    4, 300,
    6, 20, MST_NO_SPELLS, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_DRAIN_SPEED, 17}, AT_NO_ATK, AT_NO_ATK,
       AT_NO_ATK },
    8, 500,
    6, 20, MST_EIDOLON, false, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_VULN, 19}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    9, 490,
...

{
    ...
    10, MONS_TENTACLED_MONSTROSITY, MONS_TENTACLED_MONSTROSITY,
        MH_DEMONIC, 160,
    { {AT_TENTACLE_SLAP, AF_PLAIN, 16}, {AT_TENTACLE_SLAP, AF_PLAIN, 16},
      {AT_TENTACLE_SLAP, AF_PLAIN, 16}, {AT_CONSTRICT, AF_CRUSH, 8} },
    10, 800,
    5, 0, MST_NO_SPELLS, false, S_SILENT,
    I_HUMAN, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_TOUCH, AF_PLAIN, 8}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 800,
    10, 0, MST_NO_SPELLS, false, S_SILENT,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_MISC,
...

{
    ...
    { {AT_GORE, AF_PLAIN, 11}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 340,
    4, 0, MST_NO_SPELLS, true, S_BELLOW,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED,
...

{
    ...
    { {AT_GORE, AF_PLAIN, 26}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 670,
    10, 0, MST_CATOBLEPAS, true, S_BELLOW,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_QUADRUPED,
...

{
    ...
    { {AT_TRAMPLE, AF_TRAMPLE, 8}, {AT_TRUNK_SLAP, AF_PLAIN, 5}, AT_NO_ATK,
       AT_NO_ATK },
    4, 350,
    8, 0, MST_NO_SPELLS, true, S_TRUMPET,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED,
...

{
    ...
    { {AT_HIT, AF_FIRE, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 300,
    5, 0, MST_NO_SPELLS, true, S_SILENT,
    I_HUMAN, HT_AMPHIBIOUS_LAVA, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_FIRE, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 350,
    5, 0, MST_SALAMANDER_MYSTIC, true, S_SILENT,
    I_HUMAN, HT_AMPHIBIOUS_LAVA, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_NAGA,
...

{
    ...
    { {AT_HIT, AF_FIRE, 15}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 500,
    5, 0, MST_SALAMANDER_TYRANT, true, S_SILENT,
    I_HUMAN, HT_AMPHIBIOUS_LAVA, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_NAGA,
...
// animated armour - variable traits
{
    ...
    I_BRAINLESS, HT_LAND, 10, MOVE_ENERGY(20),
...

{
    ...
    { { AT_HIT, AF_PLAIN, 30 }, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 400,
    20, 0, MST_WALKING_TOME, false, S_RUSTLE,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_MISC,
...

{
    ...
    { { AT_HIT, AF_PLAIN, 10 }, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 400,
    15, 0, MST_WALKING_TOME, false, S_RUSTLE,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_MISC,
...

{
    ...
    { { AT_HIT, AF_PLAIN, 10 }, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 400,
    10, 0, MST_WALKING_TOME, false, S_RUSTLE,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_MISC,
...

{
    ...
    MR_RES_COLD | MR_VUL_FIRE,
    14, MONS_WALKING_TOME, MONS_EARTHEN_TOME, MH_NONLIVING, WILL_INVULN,
    { { AT_HIT, AF_COLD, 10 }, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    4, 400,
    10, 0, MST_WALKING_TOME, false, S_RUSTLE,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_SMALL, MON_SHAPE_MISC,
...
// Demonic tentacle things.
{
    ...
    M_NO_POLY_TO | M_STATIONARY | M_FLIES,
    mrd(MR_RES_FIRE | MR_RES_COLD | MR_RES_ELEC, 3) | MR_RES_STICKY_FLAME,
    10, MONS_ELDRITCH_TENTACLE, MONS_ELDRITCH_TENTACLE,
        MH_NONLIVING, WILL_INVULN,
    { {AT_TENTACLE_SLAP, AF_CHAOTIC, 33}, {AT_CLAW, AF_CHAOTIC, 33}, AT_NO_ATK,
       AT_NO_ATK },
    10, 600,
...
// minor demons: imps, etc. ('5')
{
    ...
    { {AT_HIT, AF_PLAIN, 6}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 90,
    2, 40, MST_NO_SPELLS, false, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_REACH, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 50,
    2, 20, MST_NO_SPELLS, false, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LITTLE,
         MON_SHAPE_HUMANOID_WINGED,
...
{
    MONS_QUASIT, '5', LIGHTGREY, "drain imp",
    M_NO_FLAGS,
    MR_NO_FLAGS,
    13, MONS_QUASIT, MONS_QUASIT, MH_DEMONIC, 10,
    { {AT_BITE, AF_DRAIN, 2}, {AT_CLAW, AF_ANTIMAGIC, 3},
      {AT_CLAW, AF_ANTIMAGIC, 3}, AT_NO_ATK },
    2, 30,
    1, 50, MST_NO_SPELLS, false, S_MOAN,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_SMALL, MON_SHAPE_HUMANOID,
...
{
    MONS_UFETUBUS, '5', LIGHTCYAN, "brain imp",
    M_NO_FLAGS,
    MR_VUL_FIRE,
    28, MONS_UFETUBUS, MONS_UFETUBUS, MH_DEMONIC, 10,
    { {AT_HIT, AF_CONFUSE, 5}, {AT_HIT, AF_PLAIN, 3}, AT_NO_ATK, AT_NO_ATK },
    2, 70,
    2, 20, MST_NO_SPELLS, false, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 140,
    9, 0, MST_NO_SPELLS, false, S_SHOUT,
    I_HUMAN, HT_LAND, 5, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_SMALL, MON_SHAPE_HUMANOID,
...
{
    MONS_LEMURE, '5', YELLOW, "acid imp",
    M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_LEMURE, MONS_LEMURE, MH_DEMONIC, 20,
    { {AT_HIT, AF_CORRODE, 5}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 60,
    5, 0, MST_NO_SPELLS, false, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
{
    MONS_GLOWING_IMP, '5', GREEN, "glowing imp",
    M_SPEAKS,
    MR_NO_FLAGS,
    10, MONS_GLOWING_IMP, MONS_GLOWING_IMP, MH_DEMONIC, 20,
    { {AT_HIT, AF_PLAIN, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    2, 80,
    3, 0, MST_GLOWING_IMP, false, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
    {TILEP_MONS_GLOWING_IMP}, TILE_ERROR
},
...
// devils etc. ('4')
{
    ...
    { {AT_HIT, AF_CORRODE, 7}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 340,
    10, 0, MST_NO_SPELLS, false, S_SCREECH,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_BARBS, 9}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 310,
    3, 10, MST_NO_SPELLS, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 5}, {AT_HIT, AF_PLAIN, 5}, {AT_HIT, AF_PLAIN, 5},
       AT_NO_ATK },
    3, 370,
    5, 40, MST_SMOKE_DEMON, false, S_ROAR,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_SMALL, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_BITE, AF_PLAIN, 10}, {AT_TRAMPLE, AF_TRAMPLE, 10}, AT_NO_ATK,
       AT_NO_ATK },
    7, 440,
    5, 30, MST_NO_SPELLS, false, S_RANDOM,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
...

{
    ...
    { {AT_HIT, AF_ANTIMAGIC, 14}, {AT_HIT, AF_ANTIMAGIC, 14},
        {AT_HIT, AF_ANTIMAGIC, 14}, {AT_HIT, AF_ANTIMAGIC, 14} },
    4, 770,
    10, 20, MST_NO_SPELLS, false, S_MOAN,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 20}, {AT_HIT, AF_PLAIN, 10}, {AT_HIT, AF_PLAIN, 10},
       AT_NO_ATK },
    8, 600,
    10, 30, MST_EXECUTIONER, false, S_SCREAM,
    I_HUMAN, HT_LAND, 20, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
...
{
    MONS_ORELING, '9', ETC_IRON, "oreling",
    M_NO_FLAGS,
    MR_NO_FLAGS,
    10, MONS_GOLEM, MONS_ORELING, MH_NONLIVING, WILL_INVULN,
    { {AT_HIT, AF_PLAIN, 14}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 270,
    10, 20, MST_NO_SPELLS, false, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_SMALL, MON_SHAPE_HUMANOID,
    {TILEP_MONS_ORELING}, TILE_ERROR
},
...

{
    ...
    { {AT_HIT, AF_PLAIN, 30}, {AT_HIT, AF_PLAIN, 30}, AT_NO_ATK, AT_NO_ATK },
    4, 1000,
    25, 0, MST_NO_SPELLS, false, S_SILENT,
    I_BRAINLESS, HT_LAND, 5, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_HUMANOID,
...
{
    MONS_GUARDIAN_GOLEM, '9', RED, "ambulatory bomb",
    M_NO_EXP_GAIN,
    MR_NO_FLAGS,
...

{
    ...
    2, 350,
    4, 10, MST_NO_SPELLS, false, S_SILENT,
    I_BRAINLESS, HT_LAND, 10, SPELL_ENERGY(20),
    MONUSE_NOTHING, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...
// statues and statue-like things (also '8')
{
    ...
    MR_VUL_FIRE | mrd(MR_RES_COLD, 3) | MR_RES_PETRIFY,
    10, MONS_STATUE, MONS_ICE_STATUE, MH_NONLIVING, WILL_INVULN,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    1, 30,
    3, 0, MST_ICE_STATUE, false, S_SILENT,
    I_HUMAN, HT_AMPHIBIOUS, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_HUMANOID,
...

{
    ...
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 500,
    12, 0, MST_OBSIDIAN_STATUE, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_LARGE, MON_SHAPE_HUMANOID,
...
// gargoyles ('9')
{
    ...
    { {AT_HIT, AF_PLAIN, 12}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 170,
    14, 0, MST_GARGOYLE, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED_TAILED,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 22}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    7, 300,
    15, 0, MST_SPLINTER_BREATH, false, S_SILENT,
    I_HUMAN, HT_LAND, 14, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED_TAILED,
...

{
    ...
    { {AT_HIT, AF_FIRE, 16}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    6, 300,
    14, 0, MST_MOLTEN_GARGOYLE, false, S_SILENT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_MEDIUM,
        MON_SHAPE_HUMANOID_WINGED_TAILED,
...
// "d"raconians.
{
    ...
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, // bigtile!
        MON_SHAPE_HUMANOID_WINGED_TAILED,
    {TILEP_MONS_PROGRAM_BUG}, TILE_ERROR
},
...
// "S"nakes and guardian serpents.
{
    ...
    I_HUMAN, HT_LAND, 15, DEFAULT_ENERGY,
    MONUSE_OPEN_DOORS, SIZE_LARGE, MON_SHAPE_SNAKE,
...
// Snails and other gastropods.
{
    ...
    MONUSE_OPEN_DOORS, SIZE_GIANT, MON_SHAPE_SNAIL,
...

{
    ...
    M_UNIQUE | M_STATIONARY | M_SPEAKS | M_FEMALE,
    mrd(MR_RES_FIRE | MR_RES_COLD, 2) | MR_RES_ELEC
        | MR_RES_PETRIFY,
    10, MONS_STATUE, MONS_STATUE, MH_NONLIVING, WILL_INVULN,
    { AT_NO_ATK, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
