...
const vector<vector<god_power>> & get_all_god_powers()
{
    static vector<vector<god_power>> god_powers =
    {
        ...
        {   { 1, "gain health from killing" },
            { 3, ABIL_MAKHLEB_HURL_DAMNATION,
                 "hurl Makhleb's damnation" },
            { 4, ABIL_MAKHLEB_GREATER_SERVANT_OF_MAKHLEB,
        ...
        // Ashenzari
        {   { 0, "Ashenzari forbids new item rewards.\n"
                 "Ashenzari provides an additional upgrade reward." },
            { 1, "Ashenzari will now detect the stairs.",
                 "Ashenzari will no longer detect the stairs.",
                 "Ashenzari detects the stairs." },
            { 2, "Ashenzari will now detect monsters.",
                 "Ashenzari will no longer detect monsters.",
                 "Ashenzari detects monsters." },
            { 4, "Ashenzari will now enhance your skills.",
                 "Ashenzari no longer enhances your skills.",
                 "Ashenzari enhances your skills." },
            { 5, "Ashenzari will now keep your mind clear.",
                 "Ashenzari will no longer keep your mind clear.",
                 "Ashenzari keeps your mind clear." },
            { 6, "Ashenzari reveals the structure of the nearby dungeon.",
...
bool vehumet_gift()
{
    ...
    // Don't get stuck just because all spells have been seen.
    ...
    {
        mprf("You are granted knowledge of %s", spell_title(spell));
