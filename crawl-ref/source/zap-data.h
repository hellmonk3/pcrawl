...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<2, 20, 1, 1>,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<2, 3, 0, 1>,
...

{
    ...
    "bolt of fire",
    200,
    new calcdice_calculator<1, 18, 1, 1>,
...

{
    ...
    "fireball",
    200,
    new calcdice_calculator<1, 4, 1, 1>,
    new tohit_calculator<40>,
...

{
    ...
    "flame wave",
    100,
    new calcdice_calculator<1, 12, 1, 1>,
    new tohit_calculator<40>,
    nullptr,
    nullptr,
    RED,
...

{
    ...
    "fireball",
    200,
    new calcdice_calculator<1, 15, 1, 1>, // less than fireball
    new tohit_calculator<40>,
    nullptr,
    nullptr,
    RED,
...

{
    ...
    "negative energy",
    200,
    new calcdice_calculator<2, 30, 1, 1>,
...

{
    ...
    new dicedef_calculator<1, 16, 2, 1>,
...

{
    ...
    new dicedef_calculator<2, 7, 1, 1>,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<1, 8, 1, 1>,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<1, 14, 0, 1>,
    new tohit_calculator<20, 1, 4>,
    YELLOW,
    false,
    BEAM_ACID,
...

{
    ...
    "bolt of magma",
    200,
    new calcdice_calculator<2, 24, 1, 1>,
...

{
    ...
    "iceblast",
    200,
    new calcdice_calculator<1, 14, 3, 5>,
    new tohit_calculator<40>,
    new dicedef_calculator<3, 3, 1, 2>, // slightly weaker than magma/fireball
    new tohit_calculator<40>,
    WHITE,
    false,
    BEAM_ICE,
...

{
    ...
    nullptr,
    nullptr,
    new dicedef_calculator<1, 4, 1, 1>,
    new tohit_calculator<14, 1, 35>,
...

{
    ...
    200,
    new dicedef_calculator<1, 25, 0, 1>,
    new tohit_calculator<40>,
    nullptr,
    nullptr,
    BROWN,
...

{
    ...
    "trick lightning",
    200,
    new calcdice_calculator<1, 40, 2, 1>,
...

{
    ...
    "fiery plasma",
    200,
    new dicedef_calculator<1, 12, 2, 1>,
    new tohit_calculator<7, 1, 40>,
...

{
    ...
    200,
    new dicedef_calculator<1, 18, 1, 2>,
    new tohit_calculator<AUTOMATIC_HIT>,
    nullptr,
    nullptr,
    ETC_ICE,
